...
<body class="gray-bg top-navigation">
               ...
               <!--  <nav class="navbar navbar-static-top" role="navigation">
                    ...
                    <div class="navbar-collapse collapse" id="navbar">
                        <ul class="nav navbar-nav">
                            <li class="active">
                                <a aria-expanded="false" role="button" href="javascript:void(0)"> 返回首页</a>
                            </li>
                            <li class="dropdown">
                        ...
                        <div class="col-md-2">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    <h1 class="no-margins"><a id="customerCount" onclick="turnToCustomer()" data-index="0"></a></h1>
    ...
    <script>
        ...
        $(function(){ 
        	var customerCount = $("#pendingCustomerCount",window.parent.document).val();
        	$("#customerCount").html(customerCount+"位");
       });
        function turnToCustomer(){
        	window.parent.$("#customerPre").click();
        }
    </script>
