...
<body>
  ...
  <iframe id="topnav" src="<%=path %>/shopnav.jsp" scrolling="no" frameborder="0" width="100%" style="height: 100px;"></iframe>
            ...
            <div id="introduce"class="introduce">
            	...
            	<ul>
					<li id="a" ><img src="<%=path %>/img/shop/success/23ac77a41907610566c3a1925177a6f6.jpg" /></li>
					<li id="b" ><img src="<%=path %>/img/shop/success/b3660567962071e71ee65b3db7311df7.jpg" /></li>
            </div>
        <div class="clear"></div>
